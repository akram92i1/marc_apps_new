...
export default function Home() {
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            ...
            if (token) {
                ...
                try {
                    const response = await axios.get(`https://semerlepresent.ca/api/users/${userId}/events`, {
                        headers: {
        ...
        const fetchUserInformation = async () => {
            ...
            if (token){
                ...
                const userId = decoded.user.id;
                try {
                    const response = await axios.get(`https://semerlepresent.ca/api/users/${userId}/userInformations`, {
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
                    });
        ...
        const fecthFinishedEvents = async () => {
            ...
            if (token) {
                ...
                try {
                    const response = await axios.get(`https://semerlepresent.ca/api/users/${userId}/finishedEvents`, {
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
                    });
        ...
        const fecthAllUsersData = async () => {
            ...
            if (token) {
              ...
              const userId = decoded.user.id;
              try {
                const response = await axios.get(`https://semerlepresent.ca/api/users/${userId}/allUsersEvents`, {
                  headers: {
                    'Authorization': `Bearer ${token}`
                  }
                });
    ...
    const handleAddEvent = async (newEvent) => {
        ...
        if (token) {
            ...
            console.log(userId);
            try {
                const response = await axios.post(`https://semerlepresent.ca/api/users/${userId}/events`, newEvent, {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
